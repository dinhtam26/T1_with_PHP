!(function () {
    ...
    function n(e) {
        document.getElementById("header-lang-img") &&
            ("en" == e
                ? (document.getElementById("header-lang-img").src = `magento-ecommerce/public/admin/assets/images/flags/us.svg`)
                : "sp" == e
                ? (document.getElementById("header-lang-img").src = "magento-ecommerce/public/admin/assets/images/flags/spain.svg")
                : "gr" == e
                ? (document.getElementById("header-lang-img").src = "magento-ecommerce/public/admin/assets/images/flags/germany.svg")
                : "it" == e
                ? (document.getElementById("header-lang-img").src = "magento-ecommerce/public/admin/assets/images/flags/italy.svg")
                : "ru" == e
                ? (document.getElementById("header-lang-img").src = "magento-ecommerce/public/admin/assets/images/flags/russia.svg")
                : "ch" == e
                ? (document.getElementById("header-lang-img").src = "magento-ecommerce/public/admin/assets/images/flags/china.svg")
                : "fr" == e
                ? (document.getElementById("header-lang-img").src = "magento-ecommerce/public/admin/assets/images/flags/french.svg")
                : "ar" == e && (document.getElementById("header-lang-img").src = "magento-ecommerce/public/admin/assets/images/flags/ae.svg"),
            localStorage.setItem("language", e),
            null == (a = localStorage.getItem("language")) && n(t),
            (e = new XMLHttpRequest()).open("GET", `magento-ecommerce/public/admin//assets/lang/` + a + ".json"),
        ...
        767 < e && document.querySelector(".hamburger-icon").classList.toggle("open"),
            ...
            "vertical" === document.documentElement.getAttribute("data-layout") &&
                (e <= 1025 && 767 < e
                    ...
                    : e <= 767 &&
                      (document.body.classList.add("vertical-sidebar-enable"), document.documentElement.setAttribute("data-sidebar-size", "lg"))),
                ...
                : (e.querySelector(".view-all") && (e.querySelector(".view-all").style.display = "none"),
                  e.querySelector(".empty-notification-elem") ||
                      (e.innerHTML +=
                          ...
                          `<img src="magento-ecommerce/public/admin/assets/images/svg/bell.svg" class="img-fluid" alt="user-pic">\t\t\t\t\t\t\t` +
        ...
        Array.from(z).forEach(function (e) {
            ...
            "flatpickr" == e.getAttribute("data-provider")
                ? ((n = e.attributes),
                  ...
                  n["data-deafult-date"] &&
                      ((t.defaultDate = n["data-deafult-date"].value.toString()), (t.dateFormat = n["data-date-format"].value.toString())),
                ...
                : "timepickr" == e.getAttribute("data-provider") &&
                  ...
                  n["data-min-time"] &&
                      ((a.enableTime = !0), (a.noCalendar = !0), (a.dateFormat = "H:i"), (a.minTime = n["data-min-time"].value.toString())),
                  n["data-max-time"] &&
                      ((a.enableTime = !0), (a.noCalendar = !0), (a.dateFormat = "H:i"), (a.minTime = n["data-max-time"].value.toString())),
                  n["data-default-time"] &&
                      ((a.enableTime = !0), (a.noCalendar = !0), (a.dateFormat = "H:i"), (a.defaultDate = n["data-default-time"].value.toString())),
                  n["data-time-inline"] &&
                      ((a.enableTime = !0), (a.noCalendar = !0), (a.defaultDate = n["data-time-inline"].value.toString()), (a.inline = !0)),
                  flatpickr(e, a));
        }),
