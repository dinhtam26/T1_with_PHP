...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Nhóm người dùng</h4>
        ...
        <div class="card" id="customerList">
            <div class="card-header border-bottom-dashed">
                ...
                <div class="row g-4 align-items-center">
                    <div class="col-sm">
                        <div>
                            <h5 class="card-title mb-0">Danh sách nhóm người dùng</h5>
                        </div>
                    </div>
                    <div class="col-sm-auto">
                        <div class="d-flex flex-wrap align-items-start gap-2">
                            ...
                            <a class="btn btn-success add-btn" href="<?php ROOT_PATH ?>userCatalogue/create"><i class="ri-add-line align-bottom me-1"></i> Thêm nhóm người dùng</a>
                            <a class="btn btn-primary" href="<?php ROOT_PATH ?>userCatalogue/permission"><i class="ri-add-line align-bottom me-1"></i> Phân quyền</a>
                        ...
                        <table class="table align-middle" id="customerTable">
                            <thead class="table-light text-muted">
                                ...
                                <tr>
                                    ...
                                    <th class="sort">Publish</th>
                                    <th class="sort">Action</th>
                                </tr>
                            </thead>
                            <tbody class="list form-check-all">
                                <?php
                                if (!empty($listUserCatalogue)) {
                                    foreach ($listUserCatalogue as $key => $userCatalogue) {
                                ?>
                                        <tr id="item-<?= $userCatalogue->id ?>">
                                            <th scope="row">
                                            ...
                                            <td class="id"><?= $userCatalogue->id ?></td>
                                            <td class="customer_name"><?= $userCatalogue->name ?></td>
                                            <td class="email"><?= $userCatalogue->code ?></td>
                                            <td class="phone"><?= $userCatalogue->description ?></td>
                                            <td> <?= $userCatalogue->quantity ?></td>
                                            <td class="status">
                                                <div class="form-check form-switch form-switch-info form-switch-md mb-3">
                                                    <input class="form-check-input" type="checkbox" name="publish" value="<?= $userCatalogue->publish ?>" <?= ($userCatalogue->publish == 1) ? "checked" : ""  ?> onchange="changeStatus(<?php echo  $userCatalogue->id; ?>, 'userCatalogue')">
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <ul class="list-inline hstack gap-2 mb-0">
                                                    <li class="list-inline-item edit">
                                                        <a href="userCatalogue/<?= $userCatalogue->id ?>/edit" class="text-primary d-inline-block edit-item-btn">
                                                            <i class="ri-pencil-fill fs-16"></i>
                                                        </a>
                                                    </li>
                                                    <li class="list-inline-item">
                                                        <a class="text-danger d-inline-block remove-item-btn delete_item" href="<?= $userCatalogue->id ?>/userCatalogue">
